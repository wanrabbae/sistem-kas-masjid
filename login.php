...
<head>
	...
	<title>Musholla Al-Hijrah | Log in</title>
	...
	<style>
		/* change background into image on dist/img/ */
		.login-page {
			background-image: url("dist/img/masjid.jpg");
...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-logo">
			...
			<br>
			<a href="login.php">
				<b>Sistem Informasi Masjid/Musholla Al-Hijrah</b></a>
		</div>
		<div class="card">
